...
const MIN_UTTER_PERIOD 	 = 300;    // min time between utterances
const MAX_UTTER_PERIOD 	 = MIN_UTTER_PERIOD * 2;   // max time between utterances
const MIN_UTTER_DURATION = 30;  	 // min utter length ( watch out if this is less than BRAIN_SENSORY_UPDATE_PERIOD!!! )
const MAX_UTTER_DURATION = 100;    // max utter length (if > than MIN_UTTER_PERIOD you risk ceaseless uttering)
