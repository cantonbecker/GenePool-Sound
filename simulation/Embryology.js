...
const MIN_UTTER_PERIOD 	 = 250;    // min time between utterances
...
const MAX_UTTER_DURATION = 50;    // max utter length (if > than MIN_UTTER_PERIOD you risk ceaseless uttering)
